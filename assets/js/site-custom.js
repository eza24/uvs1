    ...
    $("#map_extended").gMap({
        markers: [{
            ...
            html: '<h4>Оффис</h4>' +
                ...
                '<div>' +
                '<div><b>Хаяг:</b></div>' +
                '<div>Сүхбаатар дүүрэг, 1-р хороо<br> Олимпийн Гудамж 14240,<br> Сентрум Оффис 305</div>' +
                '</div>' +
                '<div>' +
                '<div><b>Утас:</b></div>' +
                '<div>77336677, 88102217,<br>7713-1717</div>' +
                '</div>' +
                '<div>' +
                '<div><b>И-Мэйл:</b></div>' +
                '<div><a href="mailto:info@altailogistic.mn">info@altailogistic.mn</a></div>' +
                '</div>' +
                '</address>',
            latitude: 47.915064,
            longitude: 106.919868,
            icon: {
