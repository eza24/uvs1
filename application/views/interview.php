            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="sn-container" style="position:relative">
                        <?php 
                            $query = $this->db->query('select * from interview where status=1 and types=1 limit 1');
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <?php 
                            $query = $this->db->query('select * from interview where status=1 and types=0 order by sort asc');
                            foreach ($query->result() as $row){       
                                $id = $row->id;
                                $pic = $row->picture;
                                $title = $row->title;
